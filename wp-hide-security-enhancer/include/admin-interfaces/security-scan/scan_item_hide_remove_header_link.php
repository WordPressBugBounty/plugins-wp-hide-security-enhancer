            ...
            function scan()
                {
                    ...
                    if ( $found_issue   )
                        {
                            ...
                            $_JSON_response['description']  =   '<div class="vulnerability-report">
                                                                            ...
                                                                            <div class="description">
                                                                                <p>' . __( 'The site pages header still contain the site JSON url.', 'wp-hide-security-enhancer' ) . '</p>
                                                                            </div>
                    ...
                    $_JSON_response['actions']      =   array (
                                                                        ...
                                                                        'help'              =>  '<a class="button tips" original-title="Get Help from AI" target="_blank" href="https://chat.openai.com/?q=Help me understand the &quot; Remove Link Header being set as default by WordPress which outputs the site JSON URL.&quot;. This is a Scan Item in WP Hide plugin">AI Help</a>',
                                                                        );  
