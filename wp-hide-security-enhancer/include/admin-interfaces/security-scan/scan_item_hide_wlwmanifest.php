            ...
            function scan()
                {
                    ...
                    if ( $found_issue   )
                        {
                            ...
                            $_JSON_response['description']  =   '<div class="vulnerability-report">
                                                                            ...
                                                                            <div class="description">
                                                                                <p>' . __( 'Unless using the Windows Live Writer, the file have no usage so should be disabled.', 'wp-hide-security-enhancer' ) . '</p>
                                                                            </div>
                    ...
                    $_JSON_response['actions']      =   array (
                                                                        ...
                                                                        'help'              =>  '<a class="button tips" original-title="Get Help from AI" target="_blank" href="https://chat.openai.com/?q=Help me understand the &quot; The wlwmanifest link is actually used by Windows Live Writer. If you don\'t te application, this is just unnecessary code.&quot;. This is a Scan Item in WP Hide plugin">AI Help</a>',
                                                                        );  
