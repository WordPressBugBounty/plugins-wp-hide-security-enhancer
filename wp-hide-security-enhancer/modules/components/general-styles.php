                                    ...
                                    case 'styles_remove_version' :
                                                                $component_setting =   array_merge ( $component_setting , array(
                                                                                                                                    ...
                                                                                                                                    'help'          =>  array(
                                                                                                                                                                ...
                                                                                                                                                                'ai_question'               =>  'Help me understand the "Remove version number from enqueued style files" option with WP Hide plugin'
                                                                                                                                                                ),
                                    ...
                                    case 'styles_remove_id_attribute' :
                                                                $component_setting =   array_merge ( $component_setting , array(
                                                                                                                                    ...
                                                                                                                                    'help'          =>  array(
                                                                                                                                                                ...
                                                                                                                                                                'option_documentation_url'  =>  'https://wp-hide.com/documentation/general-html-styles/',
                                                                                                                                                                'ai_question'               =>  'Help me understand the "Remove ID attribute from all link tags which include a stylesheet" option with WP Hide plugin'
                                                                                                                                                                ),
