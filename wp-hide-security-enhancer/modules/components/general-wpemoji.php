                                    ...
                                    case 'disable_wpemojia' :
                                                                $component_setting =   array_merge ( $component_setting , array(
                                                                                                                                    ...
                                                                                                                                    'help'          =>  array(
                                                                                                                                                                ...
                                                                                                                                                                'ai_question'               =>  'Help me understand the "Disable the Emoji icon library from being loaded" option with WP Hide plugin'
                                                                                                                                                                ),
                                    ...
                                    case 'disable_tinymce_wpemojia' :
                                                                $component_setting =   array_merge ( $component_setting , array(
                                                                                                                                    ...
                                                                                                                                    'help'          =>  array(
                                                                                                                                                                ...
                                                                                                                                                                'option_documentation_url'  =>  'https://wp-hide.com/documentation/general-html-emoji/',
                                                                                                                                                                'ai_question'               =>  'Help me understand the "Disable the TinyMCE Emoji icons library from being loaded into TinyMC" option with WP Hide plugin'
                                                                                                                                                                ),
