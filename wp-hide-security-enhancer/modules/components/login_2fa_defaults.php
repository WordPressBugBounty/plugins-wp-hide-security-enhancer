                                    ...
                                    case '2fa_enabled' :
                                                                $component_setting =   array_merge ( $component_setting , array(
                                                                                                                                ...
                                                                                                                                'help'          =>  array(
                                                                                                                                                                    ...
                                                                                                                                                                    'ai_question'               =>  'Help me understand the "Enable 2FA" option with WP Hide plugin'
                                                                                                                                                                    ),
                                    ...
                                    case '2fa_enable_for_roles' :
                                                                $component_setting =   array_merge ( $component_setting , array(
                                                                                                                                ...
                                                                                                                                'help'          =>  array(
                                                                                                                                                            ...
                                                                                                                                                            'option_documentation_url'  =>  'https://wp-hide.com/documentation/2fa-two-factor-authentication/',
                                                                                                                                                            'ai_question'               =>  'Help me understand the "Enable the 2FA for specific roles" option with WP Hide plugin'
                                                                                                                                                            ),
                                                                                                                                ) );
                                                                break;
                                    ...
                                    case '2fa_require_setup' :
                                                                $component_setting =   array_merge ( $component_setting , array(
                                                                                                                                ...
                                                                                                                                'help'          =>  array(
                                                                                                                                                                    ...
                                                                                                                                                                    'option_documentation_url'  =>  'https://wp-hide.com/documentation/2fa-two-factor-authentication/',
                                                                                                                                                                    'ai_question'               =>  'Help me understand the "Mandate the user to configure Two-Factor Authentication (2FA) during their first login" option with WP Hide plugin'
                                                                                                                                                                    ),
                                    ...
                                    case '2fa_primary' :
                                                                $component_setting =   array_merge ( $component_setting , array(
                                                                                                                                ...
                                                                                                                                'help'          =>  array(
                                                                                                                                                                    ...
                                                                                                                                                                    'option_documentation_url'  =>  'https://wp-hide.com/documentation/2fa-two-factor-authentication/',
                                                                                                                                                                    'ai_question'               =>  'Help me understand the "Primary Two-Factor Authentication Method" option with WP Hide plugin'
                                                                                                                                                                    ),
                                    ...
                                    case 'temporary_login_2fa_bypass' :
                                                                $component_setting =   array_merge ( $component_setting , array(
                                                                                                                                ...
                                                                                                                                'help'          =>  array(
                                                                                                                                                                    ...
                                                                                                                                                                    'option_documentation_url'  =>  'https://wp-hide.com/documentation/2fa-two-factor-authentication/',
                                                                                                                                                                    'ai_question'               =>  'Help me understand the "Disable 2FA when using wordpress plugins like Temporary Login Without Password" option with WP Hide plugin'
                                                                                                                                                                    ),
            ...
            function _2fa_enable_for_roles_option_html( $module_setting )
                {
                    ...
                    ?>
                        <fieldset>
                            ...
                            <br />
                            <label><input type="checkbox" class="setting-value checkbox" <?php 
                                            if ( array_search ( 'no-role', $values )    !== FALSE || count ( $values ) < 1 ) 
                                                echo 'checked="checked"';
