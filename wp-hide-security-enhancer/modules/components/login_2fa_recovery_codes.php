    ...
    class WPH_module_component_login_2fa_recovery_codes extends WPH_module_component
        {            
                                    ...
                                    case '2fa_recovery_codes' :
                                                                $component_setting =   array_merge ( $component_setting , array(
                                                                                                                                ...
                                                                                                                                'help'          =>  array(
                                                                                                                                                                    ...
                                                                                                                                                                    'ai_question'               =>  'Help me understand the "2FA - Recovery Codes" option with WP Hide plugin'
                                                                                                                                                                    ),
            ...
            */
            ...
            /**
            * Reset the Recovery Codes setup 
            * 
            * @param mixed $user_id
            */
            static public function reset_setup( $user_id )
                {
                    delete_user_meta( $user_id, '_2fa_rc_setup_completed' );    
                }
