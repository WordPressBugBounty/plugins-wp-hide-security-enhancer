                                    ...
                                    case 'new_content_path' :
                                                                $component_setting =   array_merge ( $component_setting , array(
                                                                                                                                ...
                                                                                                                                'help'          =>  array(
                                                                                                                                                                    ...
                                                                                                                                                                    'ai_question'               =>  'Help me understand the "Hide the default wp-content folder" option with WP Hide plugin'
                                                                                                                                                                    ),
                                    ...
                                    case 'block_wp_content_path' :
                                                                $component_setting =   array_merge ( $component_setting , array(
                                                                                                                                ...
                                                                                                                                'help'          =>  array(
                                                                                                                                                                    ...
                                                                                                                                                                    'option_documentation_url'  =>  'https://wp-hide.com/documentation/rewrite-wp-content/',
                                                                                                                                                                    'ai_question'               =>  'Help me understand the "Block the default wp-content folder" option with WP Hide plugin'
                                                                                                                                                                    ),
