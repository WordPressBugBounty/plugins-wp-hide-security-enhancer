                                                                ...
                                                                $component_setting =   array_merge ( $component_setting , array(
                                                                                                                                    ...
                                                                                                                                    'help'          =>  array(
                                                                                                                                                                ...
                                                                                                                                                                'description'               =>  __("The HTTP Cross-Origin-Embedder-Policy (COEP) response header prevents a document from loading any cross-origin resources that don't explicitly grant the document permission (using CORP or CORS).",    'wp-hide-security-enhancer') .
                                                                                                                                                                                                ...
                                                                                                                                                                                                "<br /><b>credentialless</b> - "  . __("A document can load cross-origin resources that are requested in no-cors mode without an explicit permission via the Cross-Origin-Resource-Policy header. In this case requests are sent without credentials: cookies are omitted in the request, and ignored in the response.",    'wp-hide-security-enhancer') ,
                                                                                                                                                                'option_documentation_url'  =>  'https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Cross-Origin-Embedder-Policy',
                                                                                                                                                                'ai_question'               =>  'Help me understand the "Security Headers - Cross-Origin-Embedder-Policy (COEP)" option with WP Hide plugin'
                                                                                                                                                                ), 
                                                                                                                                ) );
                                                                break;
                    ...
                    ?>
                        ...
                        <div class="row spacer">
                            <fieldset>
                                ...
                                <label>
                                    <input type="radio" class="radio" value="credentialless" name="value" <?php if ( $module_settings['value'] == 'credentialless' ) { ?>checked="checked"<?php } ?>> <span>credentialless</span>
                                </label>                                                                 
                            </fieldset>
                        </div>
