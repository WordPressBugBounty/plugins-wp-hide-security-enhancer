                                    ...
                                    case 'referrer_policy' :
                                                                $component_setting =   array_merge ( $component_setting , array(
                                                                                                                                    ...
                                                                                                                                    'help'          =>  array(
                                                                                                                                                                ...
                                                                                                                                                                'ai_question'               =>  'Help me understand the "Security Headers - Referrer-Policy" option with WP Hide plugin'
                                                                                                                                                                ),
                                                                                                                                ) );
                                                                break;
                                    ...
                                    foreach ( $header_options   as $option_value =>  $option_title )
                                        {
                                            ?>
                                            <label>
                                                <input type="radio" class="radio" value="<?php echo esc_attr ( $option_value ) ?>" name="value" <?php if ( $module_settings['value'] == $option_value ) { ?>checked="checked"<?php } ?>> <span><?php echo esc_html ( $option_title ) ?></span>
                                            </label>    
                                            <?php
                                        }
